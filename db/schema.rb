...
ActiveRecord::Schema.define(version: 20160301032511) do
  ...
  add_index "users", ["provider", "nickname"], name: "index_users_on_provider_and_nickname", unique: true, using: :btree
